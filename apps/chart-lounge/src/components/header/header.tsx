          ...
          <NavigationMenu.Content className={styles.Content}>
            <ul className={styles.GridLinkList}>
              {overviewLinks.map((item) => (
                <li key={item.href}>
                  <NavLink className={styles.LinkCard} href={item.href}>
...
function NavLink(props: NavigationMenu.Link.Props & { className?: string }) {
    ...
    <NavigationMenu.Link
      render={
        ...
        <Link
          href={props.href ?? '/'}
          className={
            props.className ?? pathname === props.href ? 'is-active' : ''
          }
        />
      }
      {...props}
